...
//	}
// StringeeChat.prototype.updateConversation = function (info, callback) {
//     var body = {convId: info.convId, groupName: info.name, imageUrl: info.imageUrl};
//     this.client._sendMessage(StringeeServiceType.CHAT_UPDATE_CONVERSATION, body, function (res) {
//         if (callback) {
//             callback.call(this.client, res);
//             return;
//         }
//     });
// }
// StringeeChat.prototype.deleteConversation = function (info, callback) {
//     var body = {seq: info.seq, convId: info.convId};
//     this.client._sendMessage(StringeeServiceType.CHAT_DELETE_CONVERSATION, body, function (res) {
//         if (callback) {
//             callback.call(this.client, res);
//             return;
//         }
//     });
// }
// StringeeChat.prototype.getInfo = function (conversationId, callback) {
//     var body = {convIds: conversationId};
//     this.client._sendMessage(StringeeServiceType.CHAT_GET_CONVERSATIONS_INFO, body, function (res) {
//         if (callback) {
//             callback.call(this.client, res);
//             return;
//         }
//     });
// }
// StringeeChat.prototype.loadConversations = function (info, callback) {
//     var body = {lastUpdateGreater: info.lastUpdateGreater, lastUpdateSmaller: info.lastUpdateSmaller, limit: info.limit};
//     this.client._sendMessage(StringeeServiceType.CHAT_CONVERSATION_LOAD, body, function (res) {
//         if (callback) {
//             callback.call(this.client, res);
//             return;
//         }
